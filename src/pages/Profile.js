    ...
    <div className='container shadow mt-3 p-4'>
      <div className='row'>
        <div className='col-md-6 d-flex flex-column'>
          <img className='p-2 profile-pic img-fluid' alt="profile pic" src="https://plus.unsplash.com/premium_photo-1670270204757-08153c6fd333?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=800&q=60" />
          <p className='ms-3 fs-5 fw-bold'>{user.user.email}</p>
          <p className='ms-3 fs-5'>{user.user.fullName}</p>
          <p className='ms-3 fs-5'>UI/UX Designer @Charandeep Singh | Follow @{user.user.fullName}</p>
